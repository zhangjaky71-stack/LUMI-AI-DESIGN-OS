# Main Branch Protection — NODE-04

This document is the repository-setting action required by NODE-04 when branch/ruleset administration is not available through the active GitHub connector.
...
- Require the five checks above to pass.
...
Stable required-check names are part of the repository contract. Renaming or deleting one requires updating this document, NODE-04 acceptance evidence, and the branch/ruleset configuration in the same change.
