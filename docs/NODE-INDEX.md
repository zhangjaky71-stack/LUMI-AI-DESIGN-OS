...
| NODE-04 | [CI Foundation](nodes/NODE-04-CI-FOUNDATION.md) | **COMPLETE** | GitHub Actions质量/安全门禁；Clean CI `31587555221` PASS；failure proof PR `#2` CLOSED / NOT MERGED |
...
| NODE-08 | [Canvas Technology Spike](nodes/NODE-08-CANVAS-TECHNOLOGY-SPIKE.md) | **COMPLETE** | PixiJS v8/WebGL-first + DOM overlay基线；2k/10k stress、Konva/Fabric fallback、sync P95 6.5ms/4.9ms；ADR-0001 ACCEPTED；PR `#6` |
