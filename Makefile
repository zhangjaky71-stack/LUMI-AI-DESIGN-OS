...
cost-ledger-contract:
	...
	PYTHONPATH=apps/api/src:services/model-gateway/src uv run pytest apps/api/tests/test_cost_contracts.py apps/api/tests/test_cost_api_contract.py services/model-gateway/tests/test_cost_accounting.py -q
