...
class PasswordCredential(IdMixin, MutableTimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("password_hash LIKE '$argon2id$%'", name="argon2id"),
    )
...
class EmailVerificationToken(IdMixin, CreatedAtMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("token_hash ~ '^[0-9a-f]{64}$'", name="hash"),
...
class ApiToken(IdMixin, CreatedAtMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("secret_hash ~ '^[0-9a-f]{64}$'", name="hash"),
