...
from . import models_admin as _models_admin
...
Index("ix_artifact_versions_artifact_version", ArtifactVersionModel.artifact_id, ArtifactVersionModel.version_number)
...
Index("ix_outbox_due", OutboxEventModel.organization_id, OutboxEventModel.next_publish_at, OutboxEventModel.created_at)
Index("ix_runtime_jobs_due", RuntimeJobModel.organization_id, RuntimeJobModel.status, RuntimeJobModel.next_retry_at)
Index("ix_runtime_jobs_project_status", RuntimeJobModel.project_id, RuntimeJobModel.status, RuntimeJobModel.updated_at)
Index("ix_dead_letters_org_status", DeadLetterRecordModel.organization_id, DeadLetterRecordModel.status, DeadLetterRecordModel.updated_at)
