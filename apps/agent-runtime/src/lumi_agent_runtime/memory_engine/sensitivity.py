...
_HEALTH_PATTERNS = (
    re.compile(
        r"(?i)\b(diagnosed|diagnosis|medical condition|prescription|medication|"
        r"therapy|psychiatr|oncolog|diabetes|hiv|pregnan)\b"
    ),
)
_OTHER_SENSITIVE = (
    re.compile(
