...
function fixture(actor: PlatformAdminPrincipal): AdminWorkspace {
  ...
  return {
    ...
    users: [
      {
        user_id: "user-support-64",
        display_name: "Northstar Operator",
        email_masked: "n•••@example.test",
        phone_masked: "••••6401",
        status: "ACTIVE",
        organization_ids: ["org-lumi"],
        membership_roles: ["OWNER"],
        recent_error_codes: ["MODEL_TIMEOUT"],
      },
      {
        user_id: "user-viewer-64",
        display_name: "Studio Reviewer",
        email_masked: "s•••@example.test",
        phone_masked: null,
        status: "ACTIVE",
        organization_ids: ["org-northstar"],
    ...
    runs: [
      ...
      },
      {
        ...
        tool: "design.compose",
        error_code: null,
        cost_microusd: 18_000,
        retryable: false,
        cancellable: true,
        created_at: "2026-08-15T07:35:00.000Z",
      },
    ],
    providers: [
      {
        provider_id: "image-primary",
        health: "DEGRADED",
        circuit: "HALF_OPEN",
        routing_weight_basis_points: 7000,
        synthetic_health: "DEGRADED",
        pricing_snapshot_id: "pricing-image-12",
        disabled_until: null,
        disabled_reason: null,
      },
      {
        provider_id: "reasoning-primary",
        health: "HEALTHY",
        circuit: "CLOSED",
        routing_weight_basis_points: 10000,
        synthetic_health: "HEALTHY",
        pricing_snapshot_id: "pricing-reasoning-7",
        disabled_until: null,
        disabled_reason: null,
      },
    ],
    queue: [
      {
        queue_item_id: "queue-64",
        task_id: "task-64",
        state: "DLQ",
        payload_ref: "payload://task-64/v1",
        payload_sha256:
      ...
      {
        queue_item_id: "queue-65",
        task_id: "task-65",
        state: "RUNNING",
        payload_ref: "payload://task-65/v1",
        payload_sha256:
    ...
    registry: [
      {
        ...
        deploy_diff_summary: "Prompt bundle v7; tool grants unchanged",
      },
      {
        registry_id: "brand-compliance",
        kind: "SKILL",
        name: "Brand Compliance",
        version: "v4",
        enabled: true,
        traffic_basis_points: 10000,
        deploy_diff_summary: "Rule evaluator v4",
      },
    ],
    audit: [
      {
        event_id: "audit-64",
        event_type: "ADMIN_QUEUE_REQUEUED",
        actor_id: actor.actor_id,
        target_type: "QUEUE_ITEM",
        target_id: "queue-prior",
        reason: "resolved provider incident",
        ticket_ref: "INC-6399",
