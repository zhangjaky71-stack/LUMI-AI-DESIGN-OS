...
VIDEO_REPOSITORY = ROOT / "services/video-generation/src/lumi_video_generation/repository.py"
VIDEO_ARTIFACT = ROOT / "services/video-generation/src/lumi_video_generation/artifact_adapter.py"
...
def main() -> None:
    for path in (WORKER_APP, WORKER_PROJECT, VIDEO_REPOSITORY, VIDEO_ARTIFACT, VIDEO_PERFORMANCE):
    ...
    require(HOSTED_RUNTIME.is_file(), "Hosted video runtime composition root is missing")
