...
- Permanent-error DLQ and tenant-scoped replay preserving original message identity.
- Malformed-identity broker quarantine preventing poison loops.
...
- Failure-injection unit tests for duplicate dispatch, receipt rollback, transient/permanent retry, cancellation and stale worker recovery.
...
run real RabbitMQ domain/job/DLQ round trip
