...
def result_to_dict(result: NormalizedResult) -> dict[str, Any]:
    return {
        ...
        else {"total_ms": result.timing.total_ms, "ttft_ms": result.timing.ttft_ms},
...
def result_from_dict(data: dict[str, Any]) -> NormalizedResult:
    ...
    return NormalizedResult(
        ...
        usage=ModelUsage(
            ...
            video_seconds=Decimal(str(usage_data.get("video_seconds") or "0")),
        ...
        if timing_data is None
            ...
            ttft_ms=None if timing_data.get("ttft_ms") is None else int(timing_data["ttft_ms"]),
        ),
        ...
        cost=CostEstimate(
            ...
            CostConfidence(str(cost_data.get("confidence") or "unknown")),
